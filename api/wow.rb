...
get '/data/wow/search/connected-realm/:id' do |id|
...
get '/data/wow/playable-race/index' do
  wow_api_client.race(@region).index(@options).to_json
end

get '/data/wow/playable-race/:id' do |id|
  wow_api_client.race(@region).get(id, @options).to_json
end
...
get '/data/wow/reputation-faction/index' do
  wow_api_client.reputation_faction(@region).index(@options).to_json
end

get '/data/wow/reputation-faction/:id' do |id|
  wow_api_client.reputation_faction(@region).get(id, @options).to_json
end

get '/data/wow/reputation-tiers/index' do
  wow_api_client.reputation_tier(@region).index(@options).to_json
end

get '/data/wow/reputation-tiers/:id' do |id|
  wow_api_client.reputation_tier(@region).get(id, @options).to_json
end
